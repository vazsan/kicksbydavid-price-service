...
Egy adott termékhez, avatárhoz (vásárlói perszónához) és ICP-hez generálj
5-8 különböző marketing szöget. Minden szög egy rövid, ütős mondat legyen,
ami egy adott motivációra épít - arra az avatárra szabva, akit megkaptál.
...
def generate_angles(model_name: str, avatar_name: str, icp: dict) -> list[str]:
    user_prompt = (
        f"Termék: {model_name}\n"
...
if __name__ == "__main__":
    ...
    print(generate_angles("Jordan 4", "Sneakerhead fiatal felnőtt", demo_icp))
