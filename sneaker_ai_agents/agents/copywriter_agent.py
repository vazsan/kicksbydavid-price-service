...
Csak akkor írsz, ha megkaptad az ICP-t, a marketing szöget, a hookot és a
kreatív tervet - ezeket mindig felhasználod, nem találsz ki mást.
...
def write_copy(model_name: str, icp: dict, angle: str, hook: str, creative_brief: dict) -> dict:
    user_prompt = (
        f"Termék: {model_name}\n"
